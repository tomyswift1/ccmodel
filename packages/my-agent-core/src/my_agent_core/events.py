...
事件覆盖 Agent / Turn / Message / Tool / Context 生命周期。
Hook 可以只观察事件，也可以在少数安全决策点阻断或改写执行。
"""
...
class AgentEnd(Event):
    """run() 结束。常见 stop_reason: end_turn / max_iterations / cancelled / blocked / model_error / empty_response。"""
